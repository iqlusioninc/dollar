...
var (
	...
	fd_UserPosition_deposit_pending_withdrawal protoreflect.FieldDescriptor
	fd_UserPosition_yield_pending_withdrawal   protoreflect.FieldDescriptor
	fd_UserPosition_total_pending_withdrawal   protoreflect.FieldDescriptor
...
func init() {
	...
	fd_UserPosition_deposit_pending_withdrawal = md_UserPosition.Fields().ByName("deposit_pending_withdrawal")
	fd_UserPosition_yield_pending_withdrawal = md_UserPosition.Fields().ByName("yield_pending_withdrawal")
	fd_UserPosition_total_pending_withdrawal = md_UserPosition.Fields().ByName("total_pending_withdrawal")
...
func (x *fastReflection_UserPosition) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.DepositPendingWithdrawal != "" {
		value := protoreflect.ValueOfString(x.DepositPendingWithdrawal)
		if !f(fd_UserPosition_deposit_pending_withdrawal, value) {
			return
		}
	}
	if x.YieldPendingWithdrawal != "" {
		value := protoreflect.ValueOfString(x.YieldPendingWithdrawal)
		if !f(fd_UserPosition_yield_pending_withdrawal, value) {
			return
		}
	}
	if x.TotalPendingWithdrawal != "" {
		value := protoreflect.ValueOfString(x.TotalPendingWithdrawal)
		if !f(fd_UserPosition_total_pending_withdrawal, value) {
			return
		}
	}
...
func (x *fastReflection_UserPosition) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "noble.dollar.vaults.v2.UserPosition.deposit_pending_withdrawal":
		return x.DepositPendingWithdrawal != ""
	case "noble.dollar.vaults.v2.UserPosition.yield_pending_withdrawal":
		return x.YieldPendingWithdrawal != ""
	case "noble.dollar.vaults.v2.UserPosition.total_pending_withdrawal":
		return x.TotalPendingWithdrawal != ""
...
func (x *fastReflection_UserPosition) Clear(fd protoreflect.FieldDescriptor) {
	...
	case "noble.dollar.vaults.v2.UserPosition.deposit_pending_withdrawal":
		x.DepositPendingWithdrawal = ""
	case "noble.dollar.vaults.v2.UserPosition.yield_pending_withdrawal":
		x.YieldPendingWithdrawal = ""
	case "noble.dollar.vaults.v2.UserPosition.total_pending_withdrawal":
		x.TotalPendingWithdrawal = ""
	case "noble.dollar.vaults.v2.UserPosition.active_withdrawal_requests":
...
func (x *fastReflection_UserPosition) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "noble.dollar.vaults.v2.UserPosition.deposit_pending_withdrawal":
		value := x.DepositPendingWithdrawal
		return protoreflect.ValueOfString(value)
	case "noble.dollar.vaults.v2.UserPosition.yield_pending_withdrawal":
		value := x.YieldPendingWithdrawal
		return protoreflect.ValueOfString(value)
	case "noble.dollar.vaults.v2.UserPosition.total_pending_withdrawal":
		value := x.TotalPendingWithdrawal
		return protoreflect.ValueOfString(value)
	case "noble.dollar.vaults.v2.UserPosition.active_withdrawal_requests":
...
func (x *fastReflection_UserPosition) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "noble.dollar.vaults.v2.UserPosition.deposit_pending_withdrawal":
		x.DepositPendingWithdrawal = value.Interface().(string)
	case "noble.dollar.vaults.v2.UserPosition.yield_pending_withdrawal":
		x.YieldPendingWithdrawal = value.Interface().(string)
	case "noble.dollar.vaults.v2.UserPosition.total_pending_withdrawal":
		x.TotalPendingWithdrawal = value.Interface().(string)
	case "noble.dollar.vaults.v2.UserPosition.active_withdrawal_requests":
...
func (x *fastReflection_UserPosition) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "noble.dollar.vaults.v2.UserPosition.deposit_pending_withdrawal":
		panic(fmt.Errorf("field deposit_pending_withdrawal of message noble.dollar.vaults.v2.UserPosition is not mutable"))
	case "noble.dollar.vaults.v2.UserPosition.yield_pending_withdrawal":
		panic(fmt.Errorf("field yield_pending_withdrawal of message noble.dollar.vaults.v2.UserPosition is not mutable"))
	case "noble.dollar.vaults.v2.UserPosition.total_pending_withdrawal":
		panic(fmt.Errorf("field total_pending_withdrawal of message noble.dollar.vaults.v2.UserPosition is not mutable"))
	case "noble.dollar.vaults.v2.UserPosition.active_withdrawal_requests":
...
func (x *fastReflection_UserPosition) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		l = len(x.DepositPendingWithdrawal)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		l = len(x.YieldPendingWithdrawal)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		l = len(x.TotalPendingWithdrawal)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.TotalPendingWithdrawal) > 0 {
			i -= len(x.TotalPendingWithdrawal)
			copy(dAtA[i:], x.TotalPendingWithdrawal)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.TotalPendingWithdrawal)))
			i--
			dAtA[i] = 0x42
		}
		if len(x.YieldPendingWithdrawal) > 0 {
			i -= len(x.YieldPendingWithdrawal)
			copy(dAtA[i:], x.YieldPendingWithdrawal)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.YieldPendingWithdrawal)))
			i--
			dAtA[i] = 0x3a
		}
		if len(x.DepositPendingWithdrawal) > 0 {
			i -= len(x.DepositPendingWithdrawal)
			copy(dAtA[i:], x.DepositPendingWithdrawal)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.DepositPendingWithdrawal)))
			i--
			dAtA[i] = 0x32
		}
		if x.ReceiveYield {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 6:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field DepositPendingWithdrawal", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.DepositPendingWithdrawal = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 7:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field YieldPendingWithdrawal", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.YieldPendingWithdrawal = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 8:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TotalPendingWithdrawal", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.TotalPendingWithdrawal = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 9:
				if wireType != 0 {
...
var (
	...
	fd_AccountingSnapshot_accounting_aum    protoreflect.FieldDescriptor
	fd_AccountingSnapshot_created_at_height protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_AccountingSnapshot_accounting_aum = md_AccountingSnapshot.Fields().ByName("accounting_aum")
	fd_AccountingSnapshot_created_at_height = md_AccountingSnapshot.Fields().ByName("created_at_height")
}
...
func (x *fastReflection_AccountingSnapshot) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.AccountingAum != "" {
		value := protoreflect.ValueOfString(x.AccountingAum)
		if !f(fd_AccountingSnapshot_accounting_aum, value) {
			return
		}
	}
	if x.CreatedAtHeight != int64(0) {
		value := protoreflect.ValueOfInt64(x.CreatedAtHeight)
		if !f(fd_AccountingSnapshot_created_at_height, value) {
			return
		}
	}
}
...
func (x *fastReflection_AccountingSnapshot) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "noble.dollar.vaults.v2.AccountingSnapshot.accrued_yield":
		return x.AccruedYield != ""
	case "noble.dollar.vaults.v2.AccountingSnapshot.accounting_aum":
		return x.AccountingAum != ""
	case "noble.dollar.vaults.v2.AccountingSnapshot.created_at_height":
...
func (x *fastReflection_AccountingSnapshot) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "noble.dollar.vaults.v2.AccountingSnapshot.accrued_yield":
		x.AccruedYield = value.Interface().(string)
	case "noble.dollar.vaults.v2.AccountingSnapshot.accounting_aum":
		x.AccountingAum = value.Interface().(string)
	case "noble.dollar.vaults.v2.AccountingSnapshot.created_at_height":
...
func (x *fastReflection_AccountingSnapshot) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "noble.dollar.vaults.v2.AccountingSnapshot.accounting_aum":
		panic(fmt.Errorf("field accounting_aum of message noble.dollar.vaults.v2.AccountingSnapshot is not mutable"))
	case "noble.dollar.vaults.v2.AccountingSnapshot.created_at_height":
		panic(fmt.Errorf("field created_at_height of message noble.dollar.vaults.v2.AccountingSnapshot is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: noble.dollar.vaults.v2.AccountingSnapshot"))
		}
...
func (x *fastReflection_AccountingSnapshot) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.AccountingAum) > 0 {
			i -= len(x.AccountingAum)
			copy(dAtA[i:], x.AccountingAum)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.AccountingAum)))
			i--
			dAtA[i] = 0x2a
		}
		if len(x.AccruedYield) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 5:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field AccountingAum", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.AccountingAum = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 6:
				if wireType != 0 {
...
var (
	...
	fd_WithdrawalRequest_yield_amount         protoreflect.FieldDescriptor
	fd_WithdrawalRequest_principal_amount     protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_WithdrawalRequest_yield_amount = md_WithdrawalRequest.Fields().ByName("yield_amount")
	fd_WithdrawalRequest_principal_amount = md_WithdrawalRequest.Fields().ByName("principal_amount")
}
...
func (x *fastReflection_WithdrawalRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.YieldAmount != "" {
		...
		if !f(fd_WithdrawalRequest_yield_amount, value) {
			return
		}
	}
	if x.PrincipalAmount != "" {
		value := protoreflect.ValueOfString(x.PrincipalAmount)
		if !f(fd_WithdrawalRequest_principal_amount, value) {
			return
		}
	}
}
...
func (x *fastReflection_WithdrawalRequest) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "noble.dollar.vaults.v2.WithdrawalRequest.position_id":
		return x.PositionId != uint64(0)
	case "noble.dollar.vaults.v2.WithdrawalRequest.yield_amount":
		return x.YieldAmount != ""
	case "noble.dollar.vaults.v2.WithdrawalRequest.principal_amount":
...
func (x *fastReflection_WithdrawalRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "noble.dollar.vaults.v2.WithdrawalRequest.yield_amount":
		panic(fmt.Errorf("field yield_amount of message noble.dollar.vaults.v2.WithdrawalRequest is not mutable"))
	case "noble.dollar.vaults.v2.WithdrawalRequest.principal_amount":
		panic(fmt.Errorf("field principal_amount of message noble.dollar.vaults.v2.WithdrawalRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: noble.dollar.vaults.v2.WithdrawalRequest"))
		}
...
var (
	...
	fd_VaultState_last_aum_update                  protoreflect.FieldDescriptor
	fd_VaultState_total_deposit_pending_withdrawal protoreflect.FieldDescriptor
	...
	fd_VaultState_total_eligible_deposits          protoreflect.FieldDescriptor
	fd_VaultState_total_yield_pending_withdrawal   protoreflect.FieldDescriptor
	fd_VaultState_total_pending_withdrawal         protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_VaultState_last_aum_update = md_VaultState.Fields().ByName("last_aum_update")
	fd_VaultState_total_deposit_pending_withdrawal = md_VaultState.Fields().ByName("total_deposit_pending_withdrawal")
	...
	fd_VaultState_total_eligible_deposits = md_VaultState.Fields().ByName("total_eligible_deposits")
	fd_VaultState_total_yield_pending_withdrawal = md_VaultState.Fields().ByName("total_yield_pending_withdrawal")
	fd_VaultState_total_pending_withdrawal = md_VaultState.Fields().ByName("total_pending_withdrawal")
}
...
func (x *fastReflection_VaultState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.LastAumUpdate != nil {
		value := protoreflect.ValueOfMessage(x.LastAumUpdate.ProtoReflect())
		if !f(fd_VaultState_last_aum_update, value) {
			return
		}
	}
	if x.TotalDepositPendingWithdrawal != "" {
		value := protoreflect.ValueOfString(x.TotalDepositPendingWithdrawal)
		if !f(fd_VaultState_total_deposit_pending_withdrawal, value) {
			return
		}
	}
	...
	if x.TotalEligibleDeposits != "" {
		value := protoreflect.ValueOfString(x.TotalEligibleDeposits)
		if !f(fd_VaultState_total_eligible_deposits, value) {
			return
		}
	}
	if x.TotalYieldPendingWithdrawal != "" {
		value := protoreflect.ValueOfString(x.TotalYieldPendingWithdrawal)
		if !f(fd_VaultState_total_yield_pending_withdrawal, value) {
			return
		}
	}
	if x.TotalPendingWithdrawal != "" {
		value := protoreflect.ValueOfString(x.TotalPendingWithdrawal)
		if !f(fd_VaultState_total_pending_withdrawal, value) {
			return
		}
	}
}
...
func (x *fastReflection_VaultState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "noble.dollar.vaults.v2.VaultState.last_aum_update":
		return x.LastAumUpdate != nil
	case "noble.dollar.vaults.v2.VaultState.total_deposit_pending_withdrawal":
		return x.TotalDepositPendingWithdrawal != ""
	...
	case "noble.dollar.vaults.v2.VaultState.total_eligible_deposits":
		return x.TotalEligibleDeposits != ""
	case "noble.dollar.vaults.v2.VaultState.total_yield_pending_withdrawal":
		return x.TotalYieldPendingWithdrawal != ""
	case "noble.dollar.vaults.v2.VaultState.total_pending_withdrawal":
		return x.TotalPendingWithdrawal != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_VaultState) Clear(fd protoreflect.FieldDescriptor) {
	...
	case "noble.dollar.vaults.v2.VaultState.last_aum_update":
		x.LastAumUpdate = nil
	case "noble.dollar.vaults.v2.VaultState.total_deposit_pending_withdrawal":
		x.TotalDepositPendingWithdrawal = ""
	case "noble.dollar.vaults.v2.VaultState.pending_withdrawal_requests":
		x.PendingWithdrawalRequests = int32(0)
	case "noble.dollar.vaults.v2.VaultState.total_positions":
		x.TotalPositions = uint64(0)
	case "noble.dollar.vaults.v2.VaultState.total_eligible_deposits":
		x.TotalEligibleDeposits = ""
	case "noble.dollar.vaults.v2.VaultState.total_yield_pending_withdrawal":
		x.TotalYieldPendingWithdrawal = ""
	case "noble.dollar.vaults.v2.VaultState.total_pending_withdrawal":
		x.TotalPendingWithdrawal = ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_VaultState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "noble.dollar.vaults.v2.VaultState.withdrawals_enabled":
		...
		return protoreflect.ValueOfBool(value)
	case "noble.dollar.vaults.v2.VaultState.last_aum_update":
		value := x.LastAumUpdate
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	case "noble.dollar.vaults.v2.VaultState.total_deposit_pending_withdrawal":
		value := x.TotalDepositPendingWithdrawal
		return protoreflect.ValueOfString(value)
	case "noble.dollar.vaults.v2.VaultState.pending_withdrawal_requests":
	...
	case "noble.dollar.vaults.v2.VaultState.total_positions":
		...
		return protoreflect.ValueOfUint64(value)
	case "noble.dollar.vaults.v2.VaultState.total_eligible_deposits":
		value := x.TotalEligibleDeposits
		return protoreflect.ValueOfString(value)
	case "noble.dollar.vaults.v2.VaultState.total_yield_pending_withdrawal":
		value := x.TotalYieldPendingWithdrawal
		return protoreflect.ValueOfString(value)
	case "noble.dollar.vaults.v2.VaultState.total_pending_withdrawal":
		value := x.TotalPendingWithdrawal
		return protoreflect.ValueOfString(value)
...
func (x *fastReflection_VaultState) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "noble.dollar.vaults.v2.VaultState.last_aum_update":
		x.LastAumUpdate = value.Message().Interface().(*timestamppb.Timestamp)
	case "noble.dollar.vaults.v2.VaultState.total_deposit_pending_withdrawal":
		x.TotalDepositPendingWithdrawal = value.Interface().(string)
	case "noble.dollar.vaults.v2.VaultState.pending_withdrawal_requests":
		x.PendingWithdrawalRequests = int32(value.Int())
	case "noble.dollar.vaults.v2.VaultState.total_positions":
		x.TotalPositions = value.Uint()
	case "noble.dollar.vaults.v2.VaultState.total_eligible_deposits":
		x.TotalEligibleDeposits = value.Interface().(string)
	case "noble.dollar.vaults.v2.VaultState.total_yield_pending_withdrawal":
		x.TotalYieldPendingWithdrawal = value.Interface().(string)
	case "noble.dollar.vaults.v2.VaultState.total_pending_withdrawal":
		x.TotalPendingWithdrawal = value.Interface().(string)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_VaultState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "noble.dollar.vaults.v2.VaultState.last_aum_update":
		if x.LastAumUpdate == nil {
			x.LastAumUpdate = new(timestamppb.Timestamp)
		}
		return protoreflect.ValueOfMessage(x.LastAumUpdate.ProtoReflect())
	case "noble.dollar.vaults.v2.VaultState.total_deposits":
	...
	case "noble.dollar.vaults.v2.VaultState.total_deposit_pending_withdrawal":
		panic(fmt.Errorf("field total_deposit_pending_withdrawal of message noble.dollar.vaults.v2.VaultState is not mutable"))
	case "noble.dollar.vaults.v2.VaultState.pending_withdrawal_requests":
	...
	case "noble.dollar.vaults.v2.VaultState.total_eligible_deposits":
		panic(fmt.Errorf("field total_eligible_deposits of message noble.dollar.vaults.v2.VaultState is not mutable"))
	case "noble.dollar.vaults.v2.VaultState.total_yield_pending_withdrawal":
		panic(fmt.Errorf("field total_yield_pending_withdrawal of message noble.dollar.vaults.v2.VaultState is not mutable"))
	case "noble.dollar.vaults.v2.VaultState.total_pending_withdrawal":
		panic(fmt.Errorf("field total_pending_withdrawal of message noble.dollar.vaults.v2.VaultState is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: noble.dollar.vaults.v2.VaultState"))
		}
...
func (x *fastReflection_VaultState) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.LastAumUpdate != nil {
			l = options.Size(x.LastAumUpdate)
			n += 1 + l + runtime.Sov(uint64(l))
		}
		l = len(x.TotalDepositPendingWithdrawal)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		...
		l = len(x.TotalEligibleDeposits)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		l = len(x.TotalYieldPendingWithdrawal)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		l = len(x.TotalPendingWithdrawal)
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.TotalYieldPendingWithdrawal) > 0 {
			i -= len(x.TotalYieldPendingWithdrawal)
			copy(dAtA[i:], x.TotalYieldPendingWithdrawal)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.TotalYieldPendingWithdrawal)))
			i--
			dAtA[i] = 0x62
		}
		if len(x.TotalEligibleDeposits) > 0 {
			i -= len(x.TotalEligibleDeposits)
			copy(dAtA[i:], x.TotalEligibleDeposits)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.TotalEligibleDeposits)))
			i--
			dAtA[i] = 0x5a
		}
		if x.TotalPositions != 0 {
		...
		if len(x.TotalDepositPendingWithdrawal) > 0 {
			i -= len(x.TotalDepositPendingWithdrawal)
			copy(dAtA[i:], x.TotalDepositPendingWithdrawal)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.TotalDepositPendingWithdrawal)))
			i--
			dAtA[i] = 0x42
		}
		if x.LastAumUpdate != nil {
			encoded, err := options.Marshal(x.LastAumUpdate)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 7:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field LastAumUpdate", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if x.LastAumUpdate == nil {
					x.LastAumUpdate = &timestamppb.Timestamp{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.LastAumUpdate); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 8:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TotalDepositPendingWithdrawal", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.TotalDepositPendingWithdrawal = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 9:
				if wireType != 0 {
			...
			case 11:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TotalEligibleDeposits", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.TotalEligibleDeposits = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 12:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TotalYieldPendingWithdrawal", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.TotalYieldPendingWithdrawal = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 13:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TotalPendingWithdrawal", wireType)
...
var (
	md_AUMSnapshot              protoreflect.MessageDescriptor
	fd_AUMSnapshot_aum          protoreflect.FieldDescriptor
	fd_AUMSnapshot_block_height protoreflect.FieldDescriptor
	fd_AUMSnapshot_total_shares protoreflect.FieldDescriptor
)

func init() {
	file_noble_dollar_vaults_v2_vaults_proto_init()
	md_AUMSnapshot = File_noble_dollar_vaults_v2_vaults_proto.Messages().ByName("AUMSnapshot")
	fd_AUMSnapshot_aum = md_AUMSnapshot.Fields().ByName("aum")
	fd_AUMSnapshot_block_height = md_AUMSnapshot.Fields().ByName("block_height")
	fd_AUMSnapshot_total_shares = md_AUMSnapshot.Fields().ByName("total_shares")
}

var _ protoreflect.Message = (*fastReflection_AUMSnapshot)(nil)

type fastReflection_AUMSnapshot AUMSnapshot

func (x *AUMSnapshot) ProtoReflect() protoreflect.Message {
	return (*fastReflection_AUMSnapshot)(x)
}

func (x *AUMSnapshot) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_AUMSnapshot_messageType fastReflection_AUMSnapshot_messageType
var _ protoreflect.MessageType = fastReflection_AUMSnapshot_messageType{}

type fastReflection_AUMSnapshot_messageType struct{}

func (x fastReflection_AUMSnapshot_messageType) Zero() protoreflect.Message {
	return (*fastReflection_AUMSnapshot)(nil)
}
func (x fastReflection_AUMSnapshot_messageType) New() protoreflect.Message {
	return new(fastReflection_AUMSnapshot)
}
func (x fastReflection_AUMSnapshot_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_AUMSnapshot
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_AUMSnapshot) Descriptor() protoreflect.MessageDescriptor {
	return md_AUMSnapshot
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_AUMSnapshot) Type() protoreflect.MessageType {
	return _fastReflection_AUMSnapshot_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_AUMSnapshot) New() protoreflect.Message {
	return new(fastReflection_AUMSnapshot)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_AUMSnapshot) Interface() protoreflect.ProtoMessage {
	return (*AUMSnapshot)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_AUMSnapshot) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Aum != "" {
		value := protoreflect.ValueOfString(x.Aum)
		if !f(fd_AUMSnapshot_aum, value) {
			return
		}
	}
	if x.BlockHeight != int64(0) {
		value := protoreflect.ValueOfInt64(x.BlockHeight)
		if !f(fd_AUMSnapshot_block_height, value) {
			return
		}
	}
	if x.TotalShares != "" {
		value := protoreflect.ValueOfString(x.TotalShares)
		if !f(fd_AUMSnapshot_total_shares, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_AUMSnapshot) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "noble.dollar.vaults.v2.AUMSnapshot.aum":
		return x.Aum != ""
	case "noble.dollar.vaults.v2.AUMSnapshot.block_height":
		return x.BlockHeight != int64(0)
	case "noble.dollar.vaults.v2.AUMSnapshot.total_shares":
		return x.TotalShares != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: noble.dollar.vaults.v2.AUMSnapshot"))
		}
		panic(fmt.Errorf("message noble.dollar.vaults.v2.AUMSnapshot does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_AUMSnapshot) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "noble.dollar.vaults.v2.AUMSnapshot.aum":
		x.Aum = ""
	case "noble.dollar.vaults.v2.AUMSnapshot.block_height":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_AUMSnapshot) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "noble.dollar.vaults.v2.AUMSnapshot.aum":
		value := x.Aum
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message noble.dollar.vaults.v2.AUMSnapshot does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_AUMSnapshot) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "noble.dollar.vaults.v2.AUMSnapshot.aum":
		x.Aum = value.Interface().(string)
	case "noble.dollar.vaults.v2.AUMSnapshot.block_height":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_AUMSnapshot) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "noble.dollar.vaults.v2.AUMSnapshot.aum":
		panic(fmt.Errorf("field aum of message noble.dollar.vaults.v2.AUMSnapshot is not mutable"))
	case "noble.dollar.vaults.v2.AUMSnapshot.block_height":
		panic(fmt.Errorf("field block_height of message noble.dollar.vaults.v2.AUMSnapshot is not mutable"))
	case "noble.dollar.vaults.v2.AUMSnapshot.total_shares":
		panic(fmt.Errorf("field total_shares of message noble.dollar.vaults.v2.AUMSnapshot is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: noble.dollar.vaults.v2.AUMSnapshot"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_AUMSnapshot) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "noble.dollar.vaults.v2.AUMSnapshot.aum":
		return protoreflect.ValueOfString("")
	case "noble.dollar.vaults.v2.AUMSnapshot.block_height":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_AUMSnapshot) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in noble.dollar.vaults.v2.AUMSnapshot", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_AUMSnapshot) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_AUMSnapshot) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_AUMSnapshot) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_AUMSnapshot) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*AUMSnapshot)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.Aum) > 0 {
			i -= len(x.Aum)
			copy(dAtA[i:], x.Aum)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.Aum)))
			i--
			dAtA[i] = 0xa
		}
		if input.Buf != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: AUMSnapshot: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: AUMSnapshot: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field Aum", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.Aum = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 2:
				if wireType != 0 {
...
var (
	...
	fd_AccountingCursor_accounting_aum           protoreflect.FieldDescriptor
	fd_AccountingCursor_accounting_aum_timestamp protoreflect.FieldDescriptor
...
func init() {
	...
	fd_AccountingCursor_accounting_aum = md_AccountingCursor.Fields().ByName("accounting_aum")
	fd_AccountingCursor_accounting_aum_timestamp = md_AccountingCursor.Fields().ByName("accounting_aum_timestamp")
...
func (x *fastReflection_AccountingCursor) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.AccountingAum != "" {
		value := protoreflect.ValueOfString(x.AccountingAum)
		if !f(fd_AccountingCursor_accounting_aum, value) {
			return
		}
	}
	if x.AccountingAumTimestamp != nil {
		value := protoreflect.ValueOfMessage(x.AccountingAumTimestamp.ProtoReflect())
		if !f(fd_AccountingCursor_accounting_aum_timestamp, value) {
			return
		}
	}
...
func (x *fastReflection_AccountingCursor) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "noble.dollar.vaults.v2.AccountingCursor.accounting_aum":
		return x.AccountingAum != ""
	case "noble.dollar.vaults.v2.AccountingCursor.accounting_aum_timestamp":
		return x.AccountingAumTimestamp != nil
...
func (x *fastReflection_AccountingCursor) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "noble.dollar.vaults.v2.AccountingCursor.accounting_aum":
		...
		return protoreflect.ValueOfString(value)
	case "noble.dollar.vaults.v2.AccountingCursor.accounting_aum_timestamp":
		value := x.AccountingAumTimestamp
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	case "noble.dollar.vaults.v2.AccountingCursor.positions_processed":
...
func (x *fastReflection_AccountingCursor) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "noble.dollar.vaults.v2.AccountingCursor.accounting_aum":
		x.AccountingAum = value.Interface().(string)
	case "noble.dollar.vaults.v2.AccountingCursor.accounting_aum_timestamp":
		x.AccountingAumTimestamp = value.Message().Interface().(*timestamppb.Timestamp)
	case "noble.dollar.vaults.v2.AccountingCursor.positions_processed":
...
func (x *fastReflection_AccountingCursor) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "noble.dollar.vaults.v2.AccountingCursor.accounting_aum_timestamp":
		if x.AccountingAumTimestamp == nil {
			x.AccountingAumTimestamp = new(timestamppb.Timestamp)
		}
		return protoreflect.ValueOfMessage(x.AccountingAumTimestamp.ProtoReflect())
	case "noble.dollar.vaults.v2.AccountingCursor.started_at":
		if x.StartedAt == nil {
	...
	case "noble.dollar.vaults.v2.AccountingCursor.accounting_aum":
		panic(fmt.Errorf("field accounting_aum of message noble.dollar.vaults.v2.AccountingCursor is not mutable"))
	case "noble.dollar.vaults.v2.AccountingCursor.positions_processed":
...
func (x *fastReflection_AccountingCursor) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.AccountingAumTimestamp != nil {
			l = options.Size(x.AccountingAumTimestamp)
			n += 1 + l + runtime.Sov(uint64(l))
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.AccountingAumTimestamp != nil {
			encoded, err := options.Marshal(x.AccountingAumTimestamp)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field AccountingAumTimestamp", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if x.AccountingAumTimestamp == nil {
					x.AccountingAumTimestamp = &timestamppb.Timestamp{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.AccountingAumTimestamp); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 4:
...
type UserPosition struct {
	...
	DepositPendingWithdrawal string `protobuf:"bytes,6,opt,name=deposit_pending_withdrawal,json=depositPendingWithdrawal,proto3" json:"deposit_pending_withdrawal,omitempty"`
	// Yield amount pending withdrawal
	YieldPendingWithdrawal string `protobuf:"bytes,7,opt,name=yield_pending_withdrawal,json=yieldPendingWithdrawal,proto3" json:"yield_pending_withdrawal,omitempty"`
	// Total amount pending withdrawal (deposit + yield)
	TotalPendingWithdrawal string `protobuf:"bytes,8,opt,name=total_pending_withdrawal,json=totalPendingWithdrawal,proto3" json:"total_pending_withdrawal,omitempty"`
...
func (x *UserPosition) GetDepositPendingWithdrawal() string {
	if x != nil {
		return x.DepositPendingWithdrawal
	}
	return ""
...
func (x *UserPosition) GetYieldPendingWithdrawal() string {
	if x != nil {
		return x.YieldPendingWithdrawal
	}
	return ""
...
func (x *UserPosition) GetTotalPendingWithdrawal() string {
	if x != nil {
		return x.TotalPendingWithdrawal
	}
	return ""
...
type AccountingSnapshot struct {
	...
	// AUM value used for this snapshot
	AccountingAum string `protobuf:"bytes,5,opt,name=accounting_aum,json=accountingAum,proto3" json:"accounting_aum,omitempty"`
...
func (x *AccountingSnapshot) GetAccountingAum() string {
	if x != nil {
		return x.AccountingAum
	}
	return ""
...
func (x *AccountingSnapshot) GetCreatedAtHeight() int64 {
	if x != nil {
...
type WithdrawalRequest struct {
	...
	EstimatedAmount string `protobuf:"bytes,7,opt,name=estimated_amount,json=estimatedAmount,proto3" json:"estimated_amount,omitempty"`
	...
	YieldAmount string `protobuf:"bytes,10,opt,name=yield_amount,json=yieldAmount,proto3" json:"yield_amount,omitempty"`
	// Amount withdrawn from principal deposits
	PrincipalAmount string `protobuf:"bytes,11,opt,name=principal_amount,json=principalAmount,proto3" json:"principal_amount,omitempty"`
}
...
func (x *WithdrawalRequest) GetYieldAmount() string {
	if x != nil {
		return x.YieldAmount
	}
	return ""
...
func (x *WithdrawalRequest) GetPrincipalAmount() string {
	if x != nil {
		return x.PrincipalAmount
	}
	return ""
...
type VaultState struct {
	...
	// Last AUM update timestamp
	LastAumUpdate *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=last_aum_update,json=lastAumUpdate,proto3" json:"last_aum_update,omitempty"`
	// Total deposit amount pending withdrawal
	TotalDepositPendingWithdrawal string `protobuf:"bytes,8,opt,name=total_deposit_pending_withdrawal,json=totalDepositPendingWithdrawal,proto3" json:"total_deposit_pending_withdrawal,omitempty"`
	...
	TotalEligibleDeposits string `protobuf:"bytes,11,opt,name=total_eligible_deposits,json=totalEligibleDeposits,proto3" json:"total_eligible_deposits,omitempty"`
	// Total yield amount pending withdrawal
	TotalYieldPendingWithdrawal string `protobuf:"bytes,12,opt,name=total_yield_pending_withdrawal,json=totalYieldPendingWithdrawal,proto3" json:"total_yield_pending_withdrawal,omitempty"`
	// Total pending withdrawal (deposit + yield)
	TotalPendingWithdrawal string `protobuf:"bytes,13,opt,name=total_pending_withdrawal,json=totalPendingWithdrawal,proto3" json:"total_pending_withdrawal,omitempty"`
}
...
func (x *VaultState) GetLastAumUpdate() *timestamppb.Timestamp {
	if x != nil {
		return x.LastAumUpdate
	}
	return nil
}

func (x *VaultState) GetTotalDepositPendingWithdrawal() string {
	if x != nil {
		return x.TotalDepositPendingWithdrawal
	}
	return ""
...
func (x *VaultState) GetTotalEligibleDeposits() string {
	if x != nil {
		return x.TotalEligibleDeposits
	}
	return ""
...
func (x *VaultState) GetTotalYieldPendingWithdrawal() string {
	if x != nil {
		return x.TotalYieldPendingWithdrawal
	}
	return ""
...
func (x *VaultState) GetTotalPendingWithdrawal() string {
	if x != nil {
		return x.TotalPendingWithdrawal
	}
	return ""
...
type TWAPConfig struct {
	...
	// Number of historical AUM snapshots to include in TWAP calculation
	WindowSize uint32 `protobuf:"varint,2,opt,name=window_size,json=windowSize,proto3" json:"window_size,omitempty"`
	// Minimum time between AUM snapshots (in seconds)
...
// AUMSnapshot represents a point-in-time AUM observation for TWAP
type AUMSnapshot struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// AUM value at this snapshot
	Aum string `protobuf:"bytes,1,opt,name=aum,proto3" json:"aum,omitempty"`
...
func (x *AUMSnapshot) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AUMSnapshot) ProtoMessage() {}

// Deprecated: Use AUMSnapshot.ProtoReflect.Descriptor instead.
func (*AUMSnapshot) Descriptor() ([]byte, []int) {
	return file_noble_dollar_vaults_v2_vaults_proto_rawDescGZIP(), []int{11}
}

func (x *AUMSnapshot) GetAum() string {
	if x != nil {
		return x.Aum
	}
	return ""
...
func (x *AUMSnapshot) GetBlockHeight() int64 {
	if x != nil {
...
func (x *AUMSnapshot) GetTotalShares() string {
	if x != nil {
		return x.TotalShares
	}
	return ""
...
type AccountingCursor struct {
	...
	// AUM value being applied in this accounting session
	AccountingAum string `protobuf:"bytes,2,opt,name=accounting_aum,json=accountingAum,proto3" json:"accounting_aum,omitempty"`
	// Timestamp of AUM being applied
	AccountingAumTimestamp *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=accounting_aum_timestamp,json=accountingAumTimestamp,proto3" json:"accounting_aum_timestamp,omitempty"`
...
func (x *AccountingCursor) GetAccountingAum() string {
	if x != nil {
		return x.AccountingAum
	}
	return ""
...
func (x *AccountingCursor) GetAccountingAumTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.AccountingAumTimestamp
	}
	return nil
}
...
var file_noble_dollar_vaults_v2_vaults_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xb2, 0x06, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72, 0x50, 0x6f, 0x73, 0x69, 0x74,
	0x69, 0x6f, 0x6e, 0x12, 0x57, 0x0a, 0x0e, 0x64, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x5f, 0x61,
	...
	0x61, 0x63, 0x63, 0x72, 0x75, 0x65, 0x64, 0x5f, 0x79, 0x69, 0x65, 0x6c, 0x64, 0x18, 0x02, 0x20,
	...
	,
	...
	0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x16, 0x79, 0x69, 0x65, 0x6c, 0x64, 0x50, 0x65, 0x6e, 0x64, 0x69,
	0x6e, 0x67, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x61, 0x6c, 0x12, 0x6a, 0x0a, 0x18,
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x70, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x77, 0x69,
	0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x61, 0x6c, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x42, 0x30,
	...
	,
	...
	0x6e, 0x74, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x0d, 0x64, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74,
	0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x55, 0x0a, 0x0d, 0x61, 0x63, 0x63, 0x72, 0x75, 0x65,
	0x64, 0x5f, 0x79, 0x69, 0x65, 0x6c, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42, 0x30, 0xc8,
	...
	,
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x12, 0x36, 0x0a, 0x09, 0x72, 0x65, 0x71, 0x75, 0x65,
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b,
	...
	0x61, 0x74, 0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2f, 0x2e, 0x6e, 0x6f, 0x62,
	...
	0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x42, 0x30, 0xc8,
	0xde, 0x1f, 0x00, 0xda, 0xde, 0x1f, 0x15, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x73, 0x64, 0x6b,
	0x2e, 0x69, 0x6f, 0x2f, 0x6d, 0x61, 0x74, 0x68, 0x2e, 0x49, 0x6e, 0x74, 0xd2, 0xb4, 0x2d, 0x0a,
	0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x49, 0x6e, 0x74, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52,
	...
	0x6b, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x03, 0x52, 0x12,
	0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x69, 0x67,
	0x68, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69,
	0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f,
	0x6e, 0x49, 0x64, 0x12, 0x53, 0x0a, 0x0c, 0x79, 0x69, 0x65, 0x6c, 0x64, 0x5f, 0x61, 0x6d, 0x6f,
	...
	,
	...
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x73, 0x12, 0x60, 0x0a,
	0x13, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x61, 0x63, 0x63, 0x72, 0x75, 0x65, 0x64, 0x5f, 0x79,
	0x69, 0x65, 0x6c, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x30, 0xc8, 0xde, 0x1f, 0x00,
	...
	,
	...
	0x01, 0x52, 0x15, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x45, 0x6c, 0x69, 0x67, 0x69, 0x62, 0x6c, 0x65,
	0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x73, 0x12, 0x75, 0x0a, 0x1e, 0x74, 0x6f, 0x74, 0x61,
	0x6c, 0x5f, 0x79, 0x69, 0x65, 0x6c, 0x64, 0x5f, 0x70, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x5f,
	0x77, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x61, 0x6c, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09,
	...
	0x2a, 0x01, 0x52, 0x1b, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x59, 0x69, 0x65, 0x6c, 0x64, 0x50, 0x65,
	0x6e, 0x64, 0x69, 0x6e, 0x67, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x61, 0x6c, 0x12,
	0x6a, 0x0a, 0x18, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x70, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67,
	0x5f, 0x77, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x61, 0x6c, 0x18, 0x0d, 0x20, 0x01, 0x28,
	...
	,
	...
	0x44, 0x65, 0x63, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x09, 0x79, 0x69, 0x65, 0x6c, 0x64, 0x52,
	0x61, 0x74, 0x65, 0x12, 0x4f, 0x0a, 0x10, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x69,
	...
	,
	...
	,
	...
	0x09, 0x79, 0x69, 0x65, 0x6c, 0x64, 0x52, 0x61, 0x74, 0x65, 0x12, 0x51, 0x0a, 0x11, 0x64, 0x69,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x56, 0x61, 0x75, 0x6c, 0x74, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x37, 0x64,
...
var file_noble_dollar_vaults_v2_vaults_proto_goTypes = []interface{}{
	...
	(*AUMSnapshot)(nil),           // 12: noble.dollar.vaults.v2.AUMSnapshot
...
var file_noble_dollar_vaults_v2_vaults_proto_depIdxs = []int32{
	...
	14, // 2: noble.dollar.vaults.v2.WithdrawalRequest.request_time:type_name -> google.protobuf.Timestamp
	14, // 3: noble.dollar.vaults.v2.WithdrawalRequest.unlock_time:type_name -> google.protobuf.Timestamp
	0,  // 4: noble.dollar.vaults.v2.WithdrawalRequest.status:type_name -> noble.dollar.vaults.v2.WithdrawalRequestStatus
	14, // 5: noble.dollar.vaults.v2.VaultState.last_aum_update:type_name -> google.protobuf.Timestamp
	14, // 6: noble.dollar.vaults.v2.YieldCalculation.calculation_time:type_name -> google.protobuf.Timestamp
	14, // 7: noble.dollar.vaults.v2.YieldDistribution.distribution_time:type_name -> google.protobuf.Timestamp
	14, // 8: noble.dollar.vaults.v2.AccountingCursor.accounting_aum_timestamp:type_name -> google.protobuf.Timestamp
	14, // 9: noble.dollar.vaults.v2.AccountingCursor.started_at:type_name -> google.protobuf.Timestamp
