...
func (x *fastReflection_EventInflightFundStatusChanged) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "noble.dollar.vaults.v2.EventInflightFundStatusChanged.route_id":
		x.RouteId = uint32(value.Uint())
	case "noble.dollar.vaults.v2.EventInflightFundStatusChanged.previous_status":
		x.PreviousStatus = (InflightStatus)(value.Enum())
	case "noble.dollar.vaults.v2.EventInflightFundStatusChanged.new_status":
		...
		for iNdEx < l {
			...
			case 3:
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.PreviousStatus |= InflightStatus(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *fastReflection_EventInflightFundStale) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "noble.dollar.vaults.v2.EventInflightFundStale.expected_at":
		x.ExpectedAt = value.Message().Interface().(*timestamppb.Timestamp)
	case "noble.dollar.vaults.v2.EventInflightFundStale.current_status":
		x.CurrentStatus = (InflightStatus)(value.Enum())
	case "noble.dollar.vaults.v2.EventInflightFundStale.recommended_action":
		...
		for iNdEx < l {
			...
			case 6:
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.CurrentStatus |= InflightStatus(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
type EventInflightFundStatusChanged struct {
	...
	RouteId uint32 `protobuf:"varint,2,opt,name=route_id,json=routeId,proto3" json:"route_id,omitempty"`
	// Previous status
	PreviousStatus InflightStatus `protobuf:"varint,3,opt,name=previous_status,json=previousStatus,proto3,enum=noble.dollar.vaults.v2.InflightStatus" json:"previous_status,omitempty"`
	// New status
	NewStatus InflightStatus `protobuf:"varint,4,opt,name=new_status,json=newStatus,proto3,enum=noble.dollar.vaults.v2.InflightStatus" json:"new_status,omitempty"`
	// Amount
...
func (x *EventInflightFundStatusChanged) GetPreviousStatus() InflightStatus {
	if x != nil {
...
func (x *EventInflightFundStatusChanged) GetNewStatus() InflightStatus {
	if x != nil {
		return x.NewStatus
	}
	return InflightStatus_INFLIGHT_PENDING
...
type EventInflightFundStale struct {
	...
	// Current status
	CurrentStatus InflightStatus `protobuf:"varint,6,opt,name=current_status,json=currentStatus,proto3,enum=noble.dollar.vaults.v2.InflightStatus" json:"current_status,omitempty"`
	// Recommended action
...
func (x *EventInflightFundStale) GetCurrentStatus() InflightStatus {
	if x != nil {
...
var file_noble_dollar_vaults_v2_events_proto_rawDesc = []byte{
	...
	0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x42, 0x08, 0xc8, 0xde,
	0x1f, 0x00, 0x90, 0xdf, 0x1f, 0x01, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d,
	0x70, 0x22, 0xc3, 0x03, 0x0a, 0x1e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6c, 0x69,
	...
	0x6f, 0x75, 0x74, 0x65, 0x49, 0x64, 0x12, 0x4f, 0x0a, 0x0f, 0x70, 0x72, 0x65, 0x76, 0x69, 0x6f,
	...
	0x73, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x45, 0x0a, 0x0a, 0x6e, 0x65, 0x77, 0x5f, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x26, 0x2e, 0x6e, 0x6f,
	0x62, 0x6c, 0x65, 0x2e, 0x64, 0x6f, 0x6c, 0x6c, 0x61, 0x72, 0x2e, 0x76, 0x61, 0x75, 0x6c, 0x74,
	0x73, 0x2e, 0x76, 0x32, 0x2e, 0x49, 0x6e, 0x66, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x52, 0x09, 0x6e, 0x65, 0x77, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x48,
	...
	0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d,
	0x70, 0x42, 0x08, 0xc8, 0xde, 0x1f, 0x00, 0x90, 0xdf, 0x1f, 0x01, 0x52, 0x09, 0x74, 0x69, 0x6d,
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0xf5, 0x03, 0x0a, 0x16, 0x45, 0x76, 0x65, 0x6e, 0x74,
	...
	0x78, 0x70, 0x65, 0x63, 0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x4d, 0x0a, 0x0e, 0x63, 0x75, 0x72,
	...
	0x2e, 0x76, 0x61, 0x75, 0x6c, 0x74, 0x73, 0x2e, 0x76, 0x32, 0x2e, 0x49, 0x6e, 0x66, 0x6c, 0x69,
	0x67, 0x68, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x0d, 0x63, 0x75, 0x72, 0x72, 0x65,
...
var file_noble_dollar_vaults_v2_events_proto_goTypes = []interface{}{
	...
	(InflightStatus)(0),                    // 17: noble.dollar.vaults.v2.InflightStatus
}
var file_noble_dollar_vaults_v2_events_proto_depIdxs = []int32{
	...
	17, // 13: noble.dollar.vaults.v2.EventInflightFundStatusChanged.previous_status:type_name -> noble.dollar.vaults.v2.InflightStatus
	17, // 14: noble.dollar.vaults.v2.EventInflightFundStatusChanged.new_status:type_name -> noble.dollar.vaults.v2.InflightStatus
	15, // 15: noble.dollar.vaults.v2.EventInflightFundStatusChanged.timestamp:type_name -> google.protobuf.Timestamp
	16, // 16: noble.dollar.vaults.v2.EventInflightFundCompleted.operation_type:type_name -> noble.dollar.vaults.v2.OperationType
	15, // 17: noble.dollar.vaults.v2.EventInflightFundCompleted.timestamp:type_name -> google.protobuf.Timestamp
	15, // 18: noble.dollar.vaults.v2.EventInflightFundStale.expected_at:type_name -> google.protobuf.Timestamp
	17, // 19: noble.dollar.vaults.v2.EventInflightFundStale.current_status:type_name -> noble.dollar.vaults.v2.InflightStatus
	15, // 20: noble.dollar.vaults.v2.EventInflightFundStale.timestamp:type_name -> google.protobuf.Timestamp
	15, // 21: noble.dollar.vaults.v2.EventInflightFundCleaned.timestamp:type_name -> google.protobuf.Timestamp
	15, // 22: noble.dollar.vaults.v2.EventRouteCapacityExceeded.timestamp:type_name -> google.protobuf.Timestamp
